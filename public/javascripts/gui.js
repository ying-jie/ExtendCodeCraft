...
//chenwei: Popup when creator chooses "Post New Announcement"
IDE_Morph.prototype.createAnnouncementPopup = function() {
    var msg = prompt("Please type your announcement", "");
    if (msg != null) {
        myself.sharer.socket.emit('NEW_ANNOUNCEMENT', { room: myself.shareboxId, content: msg, ownerId: tempIdentifier});
